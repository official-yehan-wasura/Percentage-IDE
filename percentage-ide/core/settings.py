...
# from percentage_ide.dependencies import pycodestyle
...
# File types supported by Percentage-IDE
FILE_TYPES = [
    ("Python files", (".py", ".pyw")),
    ("QML files", (".qml",)),
    ("HTML document", (".html", ".htm")),
    ("JavaScript program", (".js", ".jsm")),
    ("Percentage project", (".pect",))
]
# Mime types
...
def clean_locator_db(qsettings):
    ...
    if last_clean is not None:
        file_path = os.path.join(resources.PERCENTAGE_KNOWLEDGE_PATH, 'locator.db')
...
def load_settings():
    ...
    PERCENTAGE_SKIN = qsettings.value("ide/interface/skin", "Dark", type=str)
    ...
    EDITOR_SCHEME = qsettings.value(
        "editor/general/scheme", "Percentage Dark", type=str)
    ...
    from percentage_ide.extensions import handlers

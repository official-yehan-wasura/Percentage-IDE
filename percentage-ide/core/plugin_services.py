...
from percentage_ide.core import plugin_util
from percentage_ide.gui.main_panel import itab_item
#from percentage_ide.gui.main_panel import main_container
#from percentage_ide.gui import actions
#from percentage_ide.gui.explorer import explorer_container
...
class MainService(QObject):
    """
    Main Interact whith PERCENTAGE-IDE
    """
    # SIGNALS
...
###############################################################################
    ...
    def get_tab_manager(self):
        """
        Returns the TabWidget (percentage_ide.gui.main_panel.tab_widget.TabWidget)
...
###############################################################################
    ...
    def get_editor(self):
        """
        Returns the actual editor (instance of percentage_ide.gui.editor.Editor)
...
class MenuAppService(QObject):
    ...
    def add_menu(self, menu):
        """
        Add an extra menu to the Plugin Menu of PERCENTAGE
        """
        self._plugins_menu.addMenu(menu)

    def add_action(self, action):
        """
        Add an action to the Plugin Menu of PERCENTAGE
        """
...
#        percentage_ide.core.plugin_interfaces
#        """
...
class ExplorerService(QObject):
    ...
    def get_opened_projects(self):
        ...
        list of <percentage_ide.gui.explorer.tree_projects_widget.ProjectTree>
        """
